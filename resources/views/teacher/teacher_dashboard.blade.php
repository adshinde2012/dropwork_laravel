...
@section('content')
    <div data-spy="scroll"  data-offset="0">
        <!-- Image Slider-->
         <div class="card col-md-11.5 mx-2 my-2 bg-white border-info">
           ...
           <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-inner">
                 <div class="carousel-item active">
                   <img src="/images/home2.jpeg" class="d-block w-100 " style="height: 500px; opacity: 95%;" alt="/images/classmates2.png">
                 ...
                 <div class="carousel-item">
                   <img src="/images/homework8.png" class="d-block w-100" style="height: 500px; opacity: 95%;padding-top: 70px;padding-bottom: 40px;" alt="/images/classmates2.png">
