...
<div data-spy="scroll"  data-offset="0">
     <!-- Image Slider-->
      <div class="card shadow-sm col-md-11.5 mx-2 my-2 bg-white ">
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block" style ="position: absolute; top: 10%; transform: translateY(-10%);">
                  <h2 style="color: #044736 ;"><b>Stay Informed For Your Assignments</b></h2>
                  <p style="color: #044736 ;">You will receive an email for your.</p>
                </div>
              </div>
            </div>
      ...
      <h3 class="card-header mt-3 text-center bg-white mx-auto border-white" style="color: #044736 ;width: 99%; ">Services</h3>
      <div class="row mx-auto " style="width: 99%;" >
        
        <div class="shadow bg-white  my-3 mx-auto rounded" style="width: 30%;">
          <h4 class="mt-3 text-center bg-white mx-auto " style="color: #044736 ;">Assignments</h4>
          <img src="/images/circle3.jpg" class="mx-auto d-flex justify-content-center" style = "width:50%; border-radius: 70%;"></img>
          <h5 class=" text-center bg-white mx-auto px-5" style="color: #044736 ;">Teachers will upload new assignments</h5>
        </div>
        <div class="shadow bg-white  my-3 mx-auto rounded" style="width: 30%;">
          <h4 class="mt-3 text-center bg-white mx-auto " style="color: #044736 ;">Solutions</h4>
          <img src="/images/circle1.jpg" class="mx-auto d-flex justify-content-center" style = "width:50%; border-radius: 70%;"></img>
          <h5 class=" text-center bg-white mx-auto px-5" style="color: #044736 ;"> Student will upload solutions</h5>
        </div>
        <div class="shadow bg-white  my-3 mx-auto rounded" style="width: 30%;">
          <h4 class="mt-3 text-center bg-white mx-auto " style="color: #044736 ;">Score</h4>
          <img src="/images/marks2.jpg" class="mx-auto d-flex justify-content-center" style = "width:50%; border-radius: 70%; margin-top: 25px;margin-bottom: 25px;"></img>
          <h5 class=" text-center bg-white mx-auto pb-2 px-5" style="color: #044736 ;"> Student and Teachers can check score</h5>
        </div>
        <div class="shadow bg-white  my-3 mx-auto rounded" style="width: 30%;">
          <h4 class="mt-3 text-center bg-white mx-auto " style="color: #044736 ;">Reports</h4>
          <img src="/images/marks.jpg" class="mx-auto d-flex justify-content-center" style = "width:50%; border-radius: 70%; margin-top: 40px;margin-bottom: 20px;"></img>
          <h5 class=" text-center bg-white mx-auto px-5" style="color: #044736 ;"> Teachers can get reports of students</h5>
        </div>
        <div class="shadow bg-white  my-3 mx-auto rounded" style="width: 30%;">
          <h4 class="mt-3 text-center bg-white mx-auto " style="color: #044736 ;">Classmates</h4>
          <img src="/images/classmates7.png" class="mx-auto d-flex justify-content-center" style = "width:30%; border-radius: 75%;margin-top: 53px;margin-bottom: 35px;"></img>
          <h5 class=" text-center bg-white mx-auto pb-2 px-5" style="color: #044736 ;"> Students will knows their classmates</h5>
        </div>
        <div class="shadow bg-white  my-3 mx-auto rounded" style="width: 30%;">
          <h4 class="mt-3 text-center bg-white mx-auto " style="color: #044736 ;">Charts</h4>
          <img src="/images/charts.jpg" class="mx-auto d-flex justify-content-center" style = "width:50%; border-radius: 70%;"></img>
          <h5 class=" text-center bg-white mx-auto px-5" style="color: #044736 ;"> Graphical representation of student scores</h5>
        </div>
      </div>

      <!-- contact us -->
      <div class="row mx-auto my-2 bg-info " style="width: 99%; " id="contactus">
      ...
      <script>
        function smoothScroll() {
          var elmntToView = document.getElementById("contactus");
